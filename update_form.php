<?php
    ...
    $category = (int)$result['creategory'];
...
<body>
    ...
    <input type="hidden"name="id" value="<?php echo $id?>" >    
        ...
        <select name="category">
            <option value="1"<?php if($creategory === 1)echo"selected"?>>日常</option>
            <option value="2"<?php if($creategory === 2)echo"selected"?>>プログラミング</option>
        </select>
        <br>
